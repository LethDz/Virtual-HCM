...
class SelfReviewStatus extends Component {
    ...
    render() {
        ...
        switch (this.state.user_review) {
            ...
            case DECLINE:
                return <h6><Badge className={className} color="danger">Decline</Badge></h6>
            case DRAFT:
                return <h6><Badge className={className} color="warning">Draft</Badge></h6>
            default:
                return <h6><Badge className={className} color="secondary">N/A</Badge></h6>
        }
    }
}
